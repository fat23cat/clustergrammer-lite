...
import transpose_network from "./network/transpose_network.js";
import get_available_filters from "./params/get_available_filters.js";
import get_filter_default_state from "./filters/get_filter_default_state.js";
import set_defaults from "./config/set_defaults.js";
import check_sim_mat from "./config/check_sim_mat.js";
import check_nodes_for_categories from "./config/check_nodes_for_categories.js";
export default (function make_config(args) {
    ...
    if (utils.has(config.network_data, 'views')) {
        config.network_data.views.forEach(function (inst_view) {
            ...
            ['row', 'col'].forEach(function (inst_rc) {
                const has_cats = check_nodes_for_categories(inst_nodes[inst_rc + '_nodes']);
    ...
    if (!utils.is_undefined(args.row_label) &&
