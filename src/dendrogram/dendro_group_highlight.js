import d3 from "d3";
import dendro_shade_bars from "./dendro_shade_bars.js";
export default (function dendro_group_highlight(params, inst_selection, inst_data, inst_rc) {
    // only make shadows if there is more than one crop button
    if (d3.selectAll(params.root + ' .' + inst_rc + '_dendro_crop_buttons')[0]
        .length > 1) {
