import d3 from "d3";
import calc_downsampled_matrix from "./calc_downsampled_matrix.js";
import * as $ from "jquery";
export default (function calc_downsampled_levels(params) {
    // console.log('---- before ---------')
    ...
    const shouldBeDownsampled = params.viz.rect_height < min_rect_height && num_levels > 0;
