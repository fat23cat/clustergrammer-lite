...
import d3 from "d3";
export default (function play_reorder_row() {
    function run(params) {
        const text = 'Reorder the matrix based on a single\nrow or column by double-clicking a\nlabel';
        ...
        const y_trans = String(Number(row_trans) + Number(container_trans) + params.viz.rect_height / 2);
