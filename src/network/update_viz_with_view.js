const d3 = require('d3');
const make_network_using_view = require('./make_network_using_view');
const disable_sidebar = require('../sidebar/disable_sidebar');
...
module.exports = function update_viz_with_view(cgm, requested_view) {
  ...
  const new_network_data = make_network_using_view(
    cgm.config,
    cgm.params,
    requested_view
  );
