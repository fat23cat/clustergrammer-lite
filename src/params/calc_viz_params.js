import ini_label_params from "./ini_label_params.js";
import set_viz_wrapper_size from "../set_viz_wrapper_size.js";
import get_svg_dim from "./get_svg_dim.js";
import calc_label_params from "./calc_label_params.js";
import calc_clust_width from "./calc_clust_width.js";
import calc_clust_height from "./calc_clust_height.js";
import calc_val_max from "./calc_val_max.js";
import calc_matrix_params from "./calc_matrix_params.js";
import set_zoom_params from "./set_zoom_params.js";
import calc_default_fs from "./calc_default_fs.js";
import utils from "../Utils_clust.js";
import get_available_filters from "./get_available_filters.js";
import make_cat_params from "./make_cat_params.js";
export default (function calc_viz_params(params, predefined_cat_colors = true) {
