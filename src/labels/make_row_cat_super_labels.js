...
export default (function make_row_cat_super_labels(cgm) {
    ...
    const cat_tip = d3_tip_custom()
        ...
        const class_string = root_tip_selector + ' d3-tip ' + root_tip_selector + '_row_cat_super';
        return class_string;
    })
