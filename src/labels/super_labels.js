...
export default (function (params) {
    ...
    d3.select(params.viz.viz_svg)
        ...
        const inst_x = params.viz.clust.dim.width / 2 +
        ...
        const inst_font_size = params.labels.super_label_fs * params.labels.super_label_scale;
    ...
    d3.select(params.viz.viz_svg)
        ...
        const inst_y = params.viz.clust.dim.height / 2 + params.viz.norm_labels.width.col;
        return 'translate(' + inst_x + ',' + inst_y + ')';
    });
    ...
    d3.select(params.root + ' .super_row')
        ...
        .attr('transform', function () {
        const inst_text_width = d3.select(this)[0][0].getBBox().width;
        const inst_x_offset = inst_text_width / 2 + params.viz.norm_labels.width.col;
