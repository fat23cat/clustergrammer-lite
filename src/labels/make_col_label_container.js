...
import add_col_click_hlight from "./add_col_click_hlight.js";
import col_reorder from "../reorder/col_reorder.js";
import row_reorder from "../reorder/row_reorder.js";
import make_col_tooltips from "./make_col_tooltips.js";
import col_viz_aid_triangle from "./col_viz_aid_triangle.js";
export default (function make_col_label_container(cgm, text_delay = 0) {
    const params = cgm.params;
    let col_container;
    const col_nodes = params.network_data.col_nodes;
    // offset click group column label
    const x_offset_click = params.viz.x_scale.rangeBand() / 2 + params.viz.border_width.x;
