import d3 from "d3";
export default (function resize_highlights(params) {
    ...
    d3.select(params.root + ' .right_hlight')
        ...
        .attr('transform', function () {
        const tmp_translate = params.viz.x_scale(params.matrix.click_hlight_x) +
    ...
    d3.select(params.root + ' .bottom_hlight')
        ...
        .attr('height', hlight_height)
        .attr('transform', function () {
        const tmp_translate_x = params.viz.x_scale(params.matrix.click_hlight_x) + hlight_width * 0.99;
    ...
    d3.select(params.root + ' .col_top_hlight')
        ...
        const tmp_translate_x = -(params.viz.clust.dim.height +
