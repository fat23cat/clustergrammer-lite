export default (function resize_super_labels(params, ini_svg_group, delay_info = false) {
    let delays = {};
    ...
    svg_group.select('.super_col').attr('transform', function () {
        const inst_x = params.viz.clust.dim.width / 2 + params.viz.norm_labels.width.row;
